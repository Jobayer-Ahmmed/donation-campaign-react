    ...
    <div className="mt-topMargin px-12 lg:px-leftRightPadding">
      <div className="relative w-full">
        ...
        <div className="absolute bottom-0 w-full h-24 bg-black bg-opacity-40 rounded-b-lg">
          <button onClick={()=>saveDonation(title)} className="absolute left-6 bottom-6 btn border-0 text-xl capitalize font-semibold text-white px-6 py-2 rounded" style={{backgroundColor:text_button_bg}}>Donate {price}</button>
        </div>
      </div>
